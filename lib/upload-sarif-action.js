...
async function run() {
    ...
    const statusReportBase = await (0, status_report_1.createStatusReportBase)("upload-sarif", "starting", startedAt, await (0, util_1.checkDiskUsage)());
    console.log("Send status report base");
    if (!(await (0, status_report_1.sendStatusReport)(statusReportBase))) {
